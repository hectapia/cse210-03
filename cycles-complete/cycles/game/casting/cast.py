class Cast:
    ...
    def add_group(self, group):
        """Add a group in the self._actors"""
    ...
    def get_actor(self, group, actor_place):
        """Gets the first actor in the given group.
        
        Args:
            group (string): The name of the group.
            actor_place (integer) : first actor, second actor,...
        ...
        result = None
        if group in self._actors.keys():
            result = self._actors[group][actor_place-1]
        return result
